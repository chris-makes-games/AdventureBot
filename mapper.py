...
def visualize_adventure(adventure):
  ...
  nx.draw_networkx(G, pos, labels=labels, node_size=4500, node_color="skyblue", font_size=12, font_weight="bold", margins=0.1, arrowsize=20, edge_color="gray", width=2.0)
  plt.box(False)
...
def generate_map(rooms_list):
  ...
  for room_id in rooms_list:
    ...
    room = Room(room_id, room_displayname, connections)
